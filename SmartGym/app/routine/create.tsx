        ...
        {tab === 'mine' ? (
          ...
          <>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.85}
            >
              <Icon name="add" size={18} color={Colors.textOnAccent} />
                ...
                return (
                  ...
                  >
                    ...
                    <View style={styles.exerciseItemRight}>
                      ...
                      />
                      <Icon name="add-circle" size={22} color={Colors.accent} style={{ marginLeft: Spacing.sm }} />
                    </View>
                  </TouchableOpacity>
                );
              }}
...
}> = ({ exercise, exerciseImage, index, weightUnit, onChange, onRemove }) => (
  <View style={styles.exerciseRow}>
    ...
    <View style={styles.exerciseInputs}>
      {[
        ...
        { key: 'weight', label: `Weight (${weightUnit})`, placeholder: '0' },
          ...
          <TextInput
            ...
            value={
              key === 'weight'
                ...
                : (exercise as unknown as Record<string, unknown>)[key]?.toString() ?? ''
            }
            onChangeText={(v) => {
              const parsed = parseFloat(v) || 0;
              const finalValue = key === 'weight' ? getInputWeightInKg(parsed, weightUnit) : parsed;
              onChange(index, key as keyof RoutineExercise, finalValue);
            }}
          />
        </View>
      ))}
      ...
      >
        ...
        <View style={styles.colorRow}>
          {ROUTINE_COLORS.map((color) => (
            ...
            >
              {selectedColor === color && (
                <Icon name="checkmark" size={16} color={Colors.textOnAccent} />
              )}
            </TouchableOpacity>
          ))}
        </View>
