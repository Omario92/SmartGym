        ...
        <View style={styles.badgeRow}>
          ...
          {item.media.length > 0 && (
            <View style={styles.mediaBadge}>
              <Icon name="image-outline" size={10} color={Colors.textMuted} />
      ...
      <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
        ...
        <View style={styles.emptyWrap}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <Icon name="log-in-outline" size={18} color={Colors.bg} />
    ...
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      ...
      {(exercises ?? []).length > 0 && (
        <View style={styles.statsBar}>
          ...
          <View style={styles.statItem}>
            <Icon name="cloud-done-outline" size={16} color={Colors.accent} />
      ...
      {(exercises ?? []).length > 0 && (
        <View style={styles.searchWrap}>
          <Icon name="search-outline" size={16} color={Colors.textMuted} style={{ marginRight: 8 }} />
          <TextInput
