...
import { formatWeight } from '@/lib/unit';
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      {routines.length > 0 && (
        <View style={styles.searchWrap}>
          <Icon name="search" size={18} color={Colors.iconInactive} style={styles.searchIcon} />
          <TextInput
          ...
          {search.length > 0 && (
            <TouchableOpacity onPress={() => setSearch('')} hitSlop={8}>
              <Icon name="close-circle" size={18} color={Colors.iconInactive} />
            </TouchableOpacity>
          )}
        </View>
      )}
