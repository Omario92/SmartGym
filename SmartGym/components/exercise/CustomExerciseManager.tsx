            ...
            <View style={styles.itemTitleRow}>
              ...
              {isCloud ? (
                <View style={styles.cloudBadge}>
                  <Icon name="cloud-done-outline" size={10} color={Colors.accent} />
                ...
                <View style={[styles.cloudBadge, { borderColor: item.syncStatus === 'synced' ? Colors.success : Colors.warning }]}>
                  <Icon name={item.syncStatus === 'synced' ? "cloud-done-outline" : "cloud-offline-outline"} size={10} color={item.syncStatus === 'synced' ? Colors.success : Colors.warning} />
            ...
            {isCloud ? (
              ...
              <>
                ...
                <TouchableOpacity
                  ...
                  hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }}
                >
                  <Icon name="copy-outline" size={15} color={Colors.info} />
                </TouchableOpacity>
                <TouchableOpacity
  ...
  return (
    <View style={styles.root}>
      ...
      {!cloudLoading && authUser && (cloudExercises ?? []).length > 0 && (
        <View style={styles.cloudStatus}>
          <Icon name="cloud-done-outline" size={14} color={Colors.accent} />
